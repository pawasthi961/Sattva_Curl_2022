...
import avatar from "assets/sattvaimg/pattern.jpg"; //User Image
  ...
  React.useEffect(() => {
    if (navigator.platform.indexOf("Win") > -1) {
      ps = new PerfectScrollbar(sidebarWrapper.current, {
        ...
        suppressScrollY: false, //Scrolling sidebar in y
      });
    }
...
Sidebar.propTypes = {
  bgColor: PropTypes.oneOf(["white", "black", "blue", "aqua", "#499ec7"]),
