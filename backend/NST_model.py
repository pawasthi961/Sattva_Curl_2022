...
Original file is located at
    https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/f16c4cab7b50f6dea0beb900dee4bf0e/neural_style_tutorial.ipynb
"""
...
def main_neural_style_transfer(content_image_path, style_image_path, output_image_path):
    ...
    style_img = loader(style_image).unsqueeze(0).to(device, torch.float)
    content_img = loader(content_image).unsqueeze(0).to(device, torch.float)
...
# main_neural_style_transfer('content_2.jpg','style_2.jpg','output_orignal_3.jpg')
...
# save_image(output,"output_orignal.jpg")
# plt.figure()
